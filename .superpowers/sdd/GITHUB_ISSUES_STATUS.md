...
| #36 | **用户编辑/创建时修改角色无法保存** | **✅ 完成** | **✅ Closed** | **✅ Closed** |
...
| 2026-07-11 | 创建 Issue #36 (用户编辑/创建时修改角色无法保存) 并在 GitHub 上记录 | Antigravity |
| 2026-07-11 | 完成 Issue #36 修复与评审意见（权限校验、状态同步、Promise.all），关闭 GitHub Issue 并合并到 dev | Antigravity |

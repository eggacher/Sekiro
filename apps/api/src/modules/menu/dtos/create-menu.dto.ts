...
export class CreateMenuDto {
  @ApiProperty({ type: Number, required: false, description: "父菜单 ID，顶级菜单为空", example: 0 })
  @IsOptional()
  @IsInt()
  parentId?: number;
  ...
  @ApiProperty({ type: String, required: true, description: "菜单类型：directory 目录、menu 菜单、button 按钮", example: "menu" })
  @IsString()
